...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>23-Apr-2019</td>
            <th rowspan="7">
                <a href="https://github.com/begin-again/nodejs-releases/blob/set-up/v8-releases/releases.md#74">7.4</a>
            </th>
        ...
        <tr>
            ...
            <td>23-Jul-2019</td>
            <th rowspan="3">
                <a href="https://github.com/begin-again/nodejs-releases/blob/set-up/v8-releases/releases.md#75">7.5</a>
            </th>
            <th>6.10.0</th>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>04-Sep-2019</td>
            <th>
                <a href="https://github.com/begin-again/nodejs-releases/blob/set-up/v8-releases/releases.md#76">7.6</a>
            </th>
            <th>6.10.3</th>
        </tr>
        <tr>
            ...
            <td>25-Sep-2019</td>
            <th rowspan="5">
                <a href="https://github.com/begin-again/nodejs-releases/blob/set-up/v8-releases/releases.md#77">7.7</a>
            </th>
        ...
        <tr>
            ...
            <td>11-Feb-2020</td>
            <th rowspan="8">
                <a href="https://github.com/begin-again/nodejs-releases/blob/set-up/v8-releases/releases.md#78">7.8</a>
            </th>
        </tr>
        <tr>
            <td>12.17.0</td>
